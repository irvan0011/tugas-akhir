...
public class JwtUtility implements Serializable {
    ...
    //    public static final long JWT_TOKEN_VALIDITY = 5 * 12;//untuk 1 menit 5 * 12 * 1000
    public static final long JWT_TOKEN_VALIDITY = 5 * 60;//untuk t menit 5 * 60 * 1000
    @Value("${jwt.secret}")
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        return Jwts.builder().setClaims(claims).setSubject(subject).setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + JWT_TOKEN_VALIDITY * 3000000))
